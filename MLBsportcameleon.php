...
class Fantasy_Widget extends WP_Widget {
        function Fantasy_Widget() {
                /* Widget settings. */
                $widget_ops = array( 'classname' => 'fantasy', 'description' => __('Displays The Best MLB Sports News and Advice from around the web.', 'fantasy') );
                /* Widget control settings. */
                $control_ops = array( 'width' => 300, 'height' => 350, 'id_base' => 'fantasy-widget' );
                /* Create the widget. */
                $this->WP_Widget( 'fantasy-widget', __('MLB Sports Widget', 'fantasy'), $widget_ops, $control_ops );
        }
        /**
